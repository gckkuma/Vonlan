...
export const ABOUT = {
  ...
  story: [
    "Vonlan Constructions (Pvt) Ltd was founded in 2007 with a singular focus: to build the infrastructure that serves communities across Sri Lanka.",
    'From its initial water-supply contracts, Vonlan grew across highways, power and — since 2015 — building construction. Today it executes landmark work across six infrastructure sectors in Sri Lanka and the Maldives, from 350 MW power stations and national venues to luxury island resorts.',
