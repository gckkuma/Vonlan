...
export const WORK: Work[] = [
  ...
  },
  {
    ...
    blurb:
      'A five-level retail and entertainment complex — supermarket, food court, retail and twin cinemas — a landmark mixed-use development for the hill country.',
    images: ['cargills-square'],
    featured: true,
  },
  {
    ...
    location: 'Katunayake',
    blurb:
      'A world-class international airport lounge refurbishment delivered in just five months — the epitome of travel luxury and sophistication.',
    images: ['araliya-lounge'],
    featured: true,
  },
];
