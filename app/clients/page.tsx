...
const CLIENT_LOGOS: { slug: string; name: string; dark?: boolean; kw?: string; caption?: string }[] = [
  ...
  { slug: 'cargills', name: 'Cargills (Ceylon) PLC', dark: true, kw: 'distribution cent', caption: 'Cargills Distribution Centre' },
  ...
  { slug: 'airport-aviation', name: 'Airport & Aviation Services', dark: true, kw: 'araliya', caption: 'BIA Araliya & Lotus Lounges' },
